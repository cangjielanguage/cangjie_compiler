...
flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeWildcardExpr(AstExpr expr)
{
    auto wildcardExpr = RawStaticCast<const WildcardExpr*>(expr);
    auto fbNodeBase = SerializeNodeBase(wildcardExpr);
    auto fbWildcardExpr = ASTFormat::CreateWildcardExpr(builder, fbNodeBase);
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_WILDCARD_EXPR, fbWildcardExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeBinaryExpr(AstExpr expr)
{
    ...
    auto fbBinaryExpr = ASTFormat::CreateBinaryExpr(
        builder, fbNodeBase, leftExpr, rightExpr, static_cast<uint16_t>(binaryExpr->op), &operatorPos);
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_BINARY_EXPR, fbBinaryExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeIsExpr(AstExpr expr)
{
    ...
    auto fbIsExpr = ASTFormat::CreateIsExpr(builder, fbNodeBase, leftExpr, isType, &isPos);
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_IS_EXPR, fbIsExpr.Union());
}
flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeAsExpr(AstExpr expr)
{
    ...
    auto fbAsExpr = ASTFormat::CreateAsExpr(builder, fbNodeBase, leftExpr, asType, &asPos);
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_AS_EXPR, fbAsExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeLitConstExpr(AstExpr expr)
{
    ...
    auto fbLitConstExpr = ASTFormat::CreateLitConstExpr(builder, fbNodeBase, value,
    ...
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_LIT_CONST_EXPR, fbLitConstExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeUnaryExpr(AstExpr expr)
{
    ...
    auto fbUnaryExpr = ASTFormat::CreateUnaryExpr(builder, fbNodeBase, onlyExpr, op, &operatorPos);
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_UNARY_EXPR, fbUnaryExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeParenExpr(AstExpr expr)
{
    ...
    auto fbParenExpr = ASTFormat::CreateParenExpr(builder, fbNodeBase, &leftParenPos, onlyExpr, &rightParenPos);
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_PAREN_EXPR, fbParenExpr.Union());
}

flatbuffers::Offset<ASTFormat::FuncArg> NodeWriter::SerializeFuncArg(AstFuncArg funcArg)
{
    if (funcArg == nullptr) {
        return flatbuffers::Offset<ASTFormat::FuncArg>();
    }
    ...
    return ASTFormat::CreateFuncArg(builder, base, name, &namePos, &colonPos, fbExpr, &commaPos, funcArg->withInout);
}

flatbuffers::Offset<ASTFormat::CallExpr> NodeWriter::SerializeCallExpr(const CallExpr* callExpr)
{
    if (callExpr == nullptr) {
        return flatbuffers::Offset<ASTFormat::CallExpr>();
    }
    ...
    auto fbArgs =
        FlatVectorCreateHelper<ASTFormat::FuncArg, FuncArg, AstFuncArg>(callExpr->args, &NodeWriter::SerializeFuncArg);
    return ASTFormat::CreateCallExpr(builder, fbNodeBase, fbBaseFunc, &leftParenPos, fbArgs, &rightParenPos);
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeCallExpr(const Expr* expr)
{
    auto callExpr = RawStaticCast<const CallExpr*>(expr);
    auto fbCallExpr = SerializeCallExpr(callExpr);
    return ASTFormat::CreateExpr(
        builder, SerializeNodeBase(callExpr), ASTFormat::AnyExpr_CALL_EXPR, fbCallExpr.Union());
}

flatbuffers::Offset<ASTFormat::RefExpr> NodeWriter::SerializeRefExpr(const RefExpr* refExpr)
{
    if (refExpr == nullptr) {
        return flatbuffers::Offset<ASTFormat::RefExpr>();
    }
    ...
    auto fbTypeVec =
        FlatVectorCreateHelper<ASTFormat::Type, Type, AstType>(refExpr->typeArguments, &NodeWriter::SerializeType);
    auto rightAnglePos = FlatPosCreateHelper(refExpr->rightAnglePos);
    return ASTFormat::CreateRefExpr(builder, fbNodeBase, fbRef, &leftAnglePos, fbTypeVec, &rightAnglePos,
        refExpr->isThis, refExpr->isSuper, refExpr->isQuoteDollar);
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeRefExpr(const Expr* expr)
{
    auto refExpr = RawStaticCast<const RefExpr*>(expr);
    auto fbRefExpr = SerializeRefExpr(refExpr);
    return ASTFormat::CreateExpr(builder, SerializeNodeBase(refExpr), ASTFormat::AnyExpr_REF_EXPR, fbRefExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeBlockExpr(AstExpr expr)
{
    auto block = RawStaticCast<const Block*>(expr);
    auto fbBlock = SerializeBlock(block);
    return ASTFormat::CreateExpr(builder, SerializeNodeBase(block), ASTFormat::AnyExpr_BLOCK, fbBlock.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeReturnExpr(AstExpr expr)
{
    ...
    if (returnExpr->expr->TestAttr(Attribute::COMPILER_ADD)) {
        fbExpr = flatbuffers::Offset<ASTFormat::Expr>();
    }
    auto fbReturnExpr = ASTFormat::CreateReturnExpr(builder, fbNodeBase, &returnPos, fbExpr);
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_RETURN_EXPR, fbReturnExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeDoWhileExpr(AstExpr expr)
{
    ...
    auto fbDoWhileExpr =
        ASTFormat::CreateDoWhileExpr(builder, base, &doPos, body, &whilePos, &leftParenPos, condExpr, &rightParenPos);
    return ASTFormat::CreateExpr(builder, base, ASTFormat::AnyExpr_DO_WHILE_EXPR, fbDoWhileExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeAssignExpr(AstExpr expr)
{
    ...
    auto fbAssignExpr =
        ASTFormat::CreateAssignExpr(builder, fbNodeBase, fbLeftValue, assignOp, &assignPos, fbRightExpr);
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_ASSIGN_EXPR, fbAssignExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeMemberAccess(AstExpr expr)
{
    ...
    auto fbTypeArguments = FlatVectorCreateHelper<ASTFormat::Type, Type, AstType>(
    ...
    auto fbMemberAccess = ASTFormat::CreateMemberAccess(
        builder, fbNodeBase, fbBaseExpr, &dotPos, field, &fieldPos, &leftAnglePos, fbTypeArguments, &rightAnglePos);
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_MEMBER_ACCESS, fbMemberAccess.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeLetPatternDestructor(AstExpr expr)
{
    ...
    auto fbLetExpr = ASTFormat::CreateLetPatternDestructor(builder, fbNodeBase, fbPatterns, bitOrPosVector,
        &backarrowPos, initializer);
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_LET_PATTERN_DESTRUCTOR, fbLetExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeIfExpr(AstExpr expr)
{
    ...
    flatbuffers::Offset<ASTFormat::Expr> fbElseBody;
    if (!ifExpr->hasElse) {
        auto fbIfExpr = ASTFormat::CreateIfExpr(builder, fbNodeBase, &ifPos, fbCondExpr, fbBody, ifExpr->hasElse,
            &elsePos, fbElseBody, ifExpr->isElseIf, &leftParenPos, &rightParenPos);
        return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_IF_EXPR, fbIfExpr.Union());
    }
...
flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeMatchExpr(AstExpr expr)
{
    ...
    auto fbMatchcases = FlatVectorCreateHelper<ASTFormat::MatchCase, MatchCase, AstMatchCase>(
        matchExpr->matchCases, &NodeWriter::SerializeMatchCase);
    auto fbMatchcaseother = FlatVectorCreateHelper<ASTFormat::MatchCaseOther, MatchCaseOther, AstMatchCaseOther>(
        matchExpr->matchCaseOthers, &NodeWriter::SerializeMatchCaseOther);
    auto rightCurlPos = FlatPosCreateHelper(matchExpr->rightCurlPos);
    auto fbMatchExpr = ASTFormat::CreateMatchExpr(builder, fbNodeBase, matchExpr->matchMode, &leftParenPos, fbSelector,
        &rightParenPos, &leftCurlPos, fbMatchcases, fbMatchcaseother, &rightCurlPos);
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_MATCH_EXPR, fbMatchExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeWhileExpr(AstExpr expr)
{
    ...
    auto fbWhileExpr =
        ASTFormat::CreateWhileExpr(builder, fbNodeBase, &whilePos, &leftParenPos, fbCondExpr, &rightParenPos, fbBody);
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_WHILE_EXPR, fbWhileExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeArrayLit(AstExpr expr)
{
    ...
    auto fbExs =
        FlatVectorCreateHelper<ASTFormat::Expr, Expr, AstExpr>(arrayLit->children, &NodeWriter::SerializeExpr);
    ...
    auto fbArrayLit =
        ASTFormat::CreateArrayLit(builder, fbNodeBase, &leftCurlPos, fbExs, commaPosVector, &rightCurlPos);
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_ARRAY_LIT, fbArrayLit.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeTupleLit(AstExpr expr)
{
    ...
    auto fbExs =
        FlatVectorCreateHelper<ASTFormat::Expr, Expr, AstExpr>(tupleLit->children, &NodeWriter::SerializeExpr);
    ...
    auto fbTupleLit =
        ASTFormat::CreateTupleLit(builder, fbNodeBase, &leftParenPos, fbExs, commaPositions, &rightParenPos);
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_TUPLE_LIT, fbTupleLit.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeSubscriptExpr(AstExpr expr)
{
    ...
    auto fbIndexExprs =
        FlatVectorCreateHelper<ASTFormat::Expr, Expr, AstExpr>(subscriptExpr->indexExprs, &NodeWriter::SerializeExpr);
    auto rightSquarePos = FlatPosCreateHelper(subscriptExpr->rightParenPos);
    bool isTupleAccess = subscriptExpr->isTupleAccess;
    auto fbSubscriptExpr = ASTFormat::CreateSubscriptExpr(
        builder, fbNodeBase, fbBaseExpr, &leftSquarePos, fbIndexExprs, &rightSquarePos, isTupleAccess);
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_SUBSCRIPT_EXPR, fbSubscriptExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeRangeExpr(AstExpr expr)
{
    ...
    auto fbRangeExpr = ASTFormat::CreateRangeExpr(
        builder, fbNodeBase, fbStartExpr, &rangePos, fbStopExpr, &colonPos, fbStepExpr, isClosed);
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_RANGE_EXPR, fbRangeExpr.Union());
}

flatbuffers::Offset<ASTFormat::LambdaExpr> NodeWriter::SerializeLambdaExpr(const LambdaExpr* lambdaExpr)
{
    if (lambdaExpr == nullptr) {
        return flatbuffers::Offset<ASTFormat::LambdaExpr>();
    }
    ...
    return ASTFormat::CreateLambdaExpr(builder, fbNodeBase, fbBody, mockSupported);
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeLambdaExpr(const Expr* expr)
{
    auto lambdaExpr = RawStaticCast<const LambdaExpr*>(expr);
    auto fbLambdaExpr = SerializeLambdaExpr(lambdaExpr);
    return ASTFormat::CreateExpr(
        builder, SerializeNodeBase(lambdaExpr), ASTFormat::AnyExpr_LAMBDA_EXPR, fbLambdaExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeSpawnExpr(AstExpr expr)
{
    ...
    auto fbSpawnExpr = ASTFormat::CreateSpawnExpr(
        builder, fbNodeBase, &spawnPos, taskExpr, hasArg, spawnArgExpr, &leftParenPos, &rightParenPos);
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_SPAWN_EXPR, fbSpawnExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeSynchronizedExpr(AstExpr expr)
{
    ...
    auto fbSynchronizedExpr = ASTFormat::CreateSynchronizedExpr(
        builder, fbNodeBase, &syncPos, &leftParenPos, mutexExpr, &rightParenPos, body);
    return ASTFormat::CreateExpr(
        builder, fbNodeBase, ASTFormat::AnyExpr_SYNCHRONIZED_EXPR, fbSynchronizedExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeTrailingClosureExpr(AstExpr expr)
{
    auto type = ASTFormat::AnyExpr_TRAILING_CLOSURE_EXPR;
    ...
    auto fbTrailingClosureExpr = ASTFormat::CreateTrailingClosureExpr(
        builder, fbNodeBase, &leftLambdaPos, fbExpr, fbLambdaExpr, &rightLambdaPos);
    return ASTFormat::CreateExpr(builder, fbNodeBase, type, fbTrailingClosureExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeTypeConvExpr(AstExpr expr)
{
    auto type = ASTFormat::AnyExpr_TYPE_CONV_EXPR;
    ...
    auto fbTypeConvExpr =
        ASTFormat::CreateTypeConvExpr(builder, fbNodeBase, fbPrimitiveType, &leftParenPos, fbExpr, &rightParenPos);
    return ASTFormat::CreateExpr(builder, fbNodeBase, type, fbTypeConvExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeTryExpr(AstExpr expr)
{
    ...
    auto fbResource = FlatVectorCreateHelper<ASTFormat::VarDecl, VarDecl, const VarDecl*>(
    ...
    auto fbCatchBlocks =
        FlatVectorCreateHelper<ASTFormat::Block, Block, AstBlock>(tryExpr->catchBlocks, &NodeWriter::SerializeBlock);
    auto fbCatchPatterns = FlatVectorCreateHelper<ASTFormat::Pattern, Pattern, AstPattern>(
        tryExpr->catchPatterns, &NodeWriter::SerializePattern);
    std::vector<flatbuffers::Offset<ASTFormat::Handler>> vecHandlers;
    for (auto& handler : tryExpr->handlers) {
        ...
        auto fbHanlder =
            ASTFormat::CreateHandler(builder, &fbPos, fbCommandPattern, fbHandleBlock);
    ...
    auto fbTryExpr =
        ASTFormat::CreateTryExpr(builder, fbNodeBase, fbResource, tryExpr->isDesugaredFromTryWithResources,
    ...
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_TRY_EXPR, fbTryExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeThrowExpr(AstExpr expr)
{
    ...
    auto fbThrowExpr = ASTFormat::CreateThrowExpr(builder, fbNodeBase, fbExpr);
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_THROW_EXPR, fbThrowExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializePerformExpr(AstExpr expr)
{
    ...
    auto fbPerformExpr = ASTFormat::CreatePerformExpr(builder, fbNodeBase, fbExpr);
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_PERFORM_EXPR, fbPerformExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeResumeExpr(AstExpr expr)
{
    ...
    auto fbResumeExpr =
        ASTFormat::CreateResumeExpr(builder, fbNodeBase, &withPos, withExpr, &throwingPos, throwingExpr);
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_RESUME_EXPR, fbResumeExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializePrimitiveTypeExpr(AstExpr expr)
{
    ...
    auto fbPrimTypeExpr = ASTFormat::CreatePrimitiveTypeExpr(builder, fbTypeBase, typeKind);
    return ASTFormat::CreateExpr(builder, fbTypeBase, ASTFormat::AnyExpr_PRIMITIVE_TYPE_EXPR, fbPrimTypeExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeForInExpr(AstExpr expr)
{
    ...
    auto fbForInExpr = ASTFormat::CreateForInExpr(builder, fbNodeBase, &leftParenPos, fbPattern, &inPos, fbInExpr,
        &rightParenPos, &ifPos, fbPatternGuard, fbBody);
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_FOR_IN_EXPR, fbForInExpr.Union());
}

flatbuffers::Offset<ASTFormat::NodeBase> NodeWriter::SerializeNodeBase(AstNode node)
{
    if (node == nullptr) {
        return flatbuffers::Offset<ASTFormat::NodeBase>();
    }
    ...
    return ASTFormat::CreateNodeBase(builder, &beginPos, &endPos, astKind);
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeJumpExpr(AstExpr expr)
{
    auto jumpExpr = RawStaticCast<const JumpExpr*>(expr);
    auto fbNodeBase = SerializeNodeBase(jumpExpr);
    auto isBreak = jumpExpr->isBreak;
    auto fbJumpExpr = ASTFormat::CreateJumpExpr(builder, fbNodeBase, isBreak);
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_JUMP_EXPR, fbJumpExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeIncOrDecExpr(AstExpr expr)
{
    ...
    auto fbIncOrDecExpr = ASTFormat::CreateIncOrDecExpr(builder, base, op, &operatorPos, expr0);
    return ASTFormat::CreateExpr(builder, base, ASTFormat::AnyExpr_INC_OR_DEC_EXPR, fbIncOrDecExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeOptionalExpr(AstExpr expr)
{
    ...
    auto fbOptionalExpr = ASTFormat::CreateOptionalExpr(builder, fbNodeBase, baseExpr, &questPos);
    return ASTFormat::CreateExpr(builder, fbNodeBase, ASTFormat::AnyExpr_OPTIONAL_EXPR, fbOptionalExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeOptionalChainExpr(AstExpr expr)
{
    ...
    auto fbOptionalChainExpr = ASTFormat::CreateOptionalChainExpr(builder, fbNodeBase, optexpr);
    return ASTFormat::CreateExpr(
        builder, fbNodeBase, ASTFormat::AnyExpr_OPTIONAL_CHAIN_EXPR, fbOptionalChainExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeTokenPart(AstExpr expr)
{
    ...
    auto fbTokenPart = ASTFormat::CreateTokenPart(builder, fbTokens);
    return ASTFormat::CreateExpr(
        builder, SerializeNodeBase(tokenPart), ASTFormat::AnyExpr_TOKEN_PART, fbTokenPart.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeQuoteExpr(AstExpr expr)
{
    ...
    std::vector<flatbuffers::Offset<ASTFormat::Expr>> vecExpr;
    for (auto& child : quoteExpr->exprs) {
        vecExpr.push_back(SerializeExpr(child.get()));
    }
    auto fbExprs = builder.CreateVector(vecExpr);
    auto fbQuoteExpr = ASTFormat::CreateQuoteExpr(builder, base, &leftParenPos, fbExprs, &rightParenPos);
    return ASTFormat::CreateExpr(builder, base, ASTFormat::AnyExpr_QUOTE_EXPR, fbQuoteExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeMacroExpandExpr(AstExpr expr)
{
    ...
    auto annotationVec = FlatVectorCreateHelper<ASTFormat::Annotation, Annotation, AstAnnotation>(
        macroExpandExpr->annotations, &NodeWriter::SerializeAnnotation);
    std::vector<flatbuffers::Offset<ASTFormat::Modifier>> vecModifier;
    ...
    auto fbMacroExpandExpr = ASTFormat::CreateMacroExpandExpr(
        builder, base, invocation, identifier, &identifierPos, annotationVec, fbModVec);
    return ASTFormat::CreateExpr(builder, base, ASTFormat::AnyExpr_MACRO_EXPAND_EXPR, fbMacroExpandExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeArrayExpr(AstExpr expr)
{
    ...
    auto args = FlatVectorCreateHelper<ASTFormat::FuncArg, FuncArg, AstFuncArg>(
    ...
    auto fbArrayExpr =
        ASTFormat::CreateArrayExpr(builder, base, type, &leftParenPos, args, &rightParenPos, isValueArray);
    return ASTFormat::CreateExpr(builder, base, ASTFormat::AnyExpr_ARRAY_EXPR, fbArrayExpr.Union());
}

flatbuffers::Offset<ASTFormat::Expr> NodeWriter::SerializeExpr(AstExpr expr)
{
    if (expr == nullptr) {
        return flatbuffers::Offset<ASTFormat::Expr>();
    }
    static std::unordered_map<AST::ASTKind, std::function<ASTFormatExpr(NodeWriter & nw, AstExpr expr)>>
        serializeExprMap = {
