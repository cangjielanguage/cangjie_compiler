...
#include "cangjie/AST/ASTModalInfo.h"
...
using TyVarEnv = std::map<Ptr<TyVar>, std::set<ModalTy>>;
...
struct Node {
    ...
    ModalTy GetTy() const { return ty; }
    Cangjie::AST::DataTy DataTy() const { return ty.get(); }

    TypeKind TyKind() const { return ty.Kind(); }
    ModalInfo TyMode() const { return ty.Mode(); }

    void SetTy(ModalTy newTy) { ty = newTy; }
...
struct Type : Node {
    ...
    ASTModalInfo modal; /**< Modal type info, Optional */
...
struct BuiltInDecl : public Decl {
    ...
    std::vector<OwnedPtr<Decl>> members;
};
...
struct FuncParamBase : VarDecl {
    Position commaPos;

protected:
    explicit FuncParamBase(ASTKind kind) : VarDecl(kind)
    {
    }
};

struct ThisParam : FuncParamBase {
    Position thisPos;
    ASTModalInfo modal;
    explicit ThisParam() : FuncParamBase(ASTKind::THIS_PARAM)
    {
    }
};
...
struct FuncParamList : Node {
    ...
    OwnedPtr<ThisParam> thisParam;             /**< Explicit this parameter. Generated by parser, Optional */
    Position rightParenPos;                    /**< Position of ')'. Generated by parser */
...
struct FuncDecl : Decl {
    Position leftParenPos;       /**< Position of '('. Generated by parser*/
    Position rightParenPos;      /**< Position of ')'. Generated by parser*/
    ASTModalInfo modal;          /**< Position of @local. Generated by parser */
    ...
    bool needsRegion{false}; /**< Whether the func needs region. Set by sema, used by CHIR. */
    size_t variadicArgIndex{0};                             /**< Index of '...'. */
    bool hasVariableLenArg{false};     /**< Whether have variable length argument. */
    bool isConst{false};               /**< A flag to mark whether the decl is const. Generated by parser */
...
struct CallExpr : Expr {
    ...
    Position rightParenPos;                    /**< Position of ')'. */
    ASTModalInfo modal;                        /**< Postfix modal on constructor call, e.g. C() @local!. */
...
struct NameReferenceExpr : Expr {
    ...
    ModalTy matchedParentTy{}; /**< The determined parent ty of current reference's context structure type. */
...
struct MemberAccess : NameReferenceExpr {
    ...
    SrcIdentifier field;
    std::vector<Ptr<Decl>> targets; /**< If the accessed symbol is a function name, this field stores overloaded
...
struct TypeConvExpr : Expr {
    ...
    Position rightParenPos; /**< Position of ')'. */
    ASTModalInfo modal;     /**< Postfix modal on type conv, Optional. e.g. Int64(3) @local!. */
...
struct ExclaveExpr : Expr {
    Position exclavePos;  /**< The position of 'exclave'. */
    OwnedPtr<Block> body; /**< The body of the exclave. */
    ExclaveExpr() : Expr(ASTKind::EXCLAVE_EXPR)
    {
    }
};
